...
- a dedicated Backup & restore workspace for encrypted-by-default or explicitly unencrypted single-file backups of the full library or selected charts, with merge-only restore;
